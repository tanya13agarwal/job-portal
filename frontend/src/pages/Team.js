            ...
            <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-white dark:border-gray-300">
                ...
                <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-white dark:border-gray-300">
                    ...
                    <div class="p-5">
                        ...
                        <span class="text-gray-500 dark:text-gray-400">CSE</span>
                        <p class="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">She is responsible for bringing the website to life through responsive design and interactive elements using HTML, CSS, and JavaScript. She ensures that users experience a seamless and engaging interface</p>
