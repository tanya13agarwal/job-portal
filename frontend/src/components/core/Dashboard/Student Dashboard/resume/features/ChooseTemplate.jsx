...
const ChooseTemplate = () => {
  ...
  return (
    <div className='flex flex-col gap-6 p-4 sm:p-6 md:p-8'>
      ...
      <div className="p-4 md:p-6 border-gray-200 rounded-lg">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {templates.map((template) => (
            <div key={template.id} className="bg-gray-100 p-4 rounded-lg shadow hover:scale-105 transition-all duration-200">
              <img src={template.image} alt={template.name} className="w-full h-32 sm:h-40 object-cover mb-4" />
              <h3 className="text-base sm:text-lg font-bold mb-2">{template.name}</h3>
