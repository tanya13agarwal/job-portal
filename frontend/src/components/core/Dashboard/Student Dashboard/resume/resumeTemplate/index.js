  ...
  return (
    <div className='grid sm:grid-cols-2 grid-cols-1 col-span-1 gap-10 justify-between'>
      <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">With pre-designed, professional templates already available, all you need to do is enter your personal details, skills, work experience, and other relevant information. The template does the rest, organizing your information into a polished, visually appealing format that stands out to employers. Just fill in your details, and your resume is ready to download and use!</p>
        <button onClick={() => setActiveComponent('createResume')} className="px-4 flex items-center gap-2 w-fit py-2 rounded border border-transparent active:scale-90 text-[#fff] bg-customDarkBlue transition-all duration-200 hover:bg-transparent hover:text-black hover:border-[0.5px] hover:border-customDarkBlue">
      ...
      <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <button onClick={() => setActiveComponent('chooseTemplate')} className="px-4 flex items-center gap-2 w-fit py-2 rounded border border-transparent active:scale-90 text-[#fff] bg-customDarkBlue transition-all duration-200 hover:bg-transparent hover:text-black hover:border-[0.5px] hover:border-customDarkBlue">
          <p className="text-nowrap">Create</p>
          <IoMdArrowRoundBack className="rotate-180" />
        </button>
      </div>
      ...
      <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <button onClick={() => setActiveComponent('resumeSamples')} className="px-4 flex items-center gap-2 w-fit py-2 rounded border border-transparent active:scale-90 text-[#fff] bg-customDarkBlue transition-all duration-200 hover:bg-transparent hover:text-black hover:border-[0.5px] hover:border-customDarkBlue">
          <p className="text-nowrap">Create</p>
          <IoMdArrowRoundBack className="rotate-180" />
        </button>
      </div>
      ...
      <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <button onClick={() => setActiveComponent('atsScoreChecker')} className="px-4 flex items-center gap-2 w-fit py-2 rounded border border-transparent active:scale-90 text-[#fff] bg-customDarkBlue transition-all duration-200 hover:bg-transparent hover:text-black hover:border-[0.5px] hover:border-customDarkBlue">
          <p className="text-nowrap">Create</p>
          <IoMdArrowRoundBack className="rotate-180" />
        </button>
      </div>
