...
const JobView = () => {
  ...
  return (
    <div className='mx-auto w-full mt-10 mb-10 px-4 lg:px-8'>
      {loading ? (
        <div className='w-full h-screen flex flex-col items-center justify-center'>
          <img src={logo} alt="logo" className='w-16 h-16 lg:w-20 lg:h-20' />
          <p className='font-semibold text-xl lg:text-2xl mt-6 text-center'>Please wait while the page is loading...</p>
        </div>
      ) : (
        <div>
          <div className='flex w-full items-center justify-center text-2xl lg:text-4xl mb-10 text-center'>All Jobs</div>
          
          <div className='mb-10'>
            <h2 className='text-xl lg:text-2xl font-medium mb-5'>Published Jobs</h2>
            <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6 lg:gap-10 mb-5'>
              {publishedJobs.map((job, index) => (
                <div key={index}>
                  <CompanyCard
                    image={job.companyDetails.thumbnail}
          ...
          <div>
            <h2 className='text-xl lg:text-2xl font-medium mb-5 pt-8'>Unpublished Jobs</h2>
            <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-6 lg:gap-10 mb-5'>
              {unpublishedJobs.map((job, index) => (
                <div key={index}>
                  <CompanyCard
