...
export default function AddCourse() {
  return (
    <>
      <div className="flex flex-wrap w-full items-start gap-x-6 gap-y-8">
        <div className="flex flex-1 flex-col">
          <h1 className="mb-10 text-2xl md:text-3xl font-medium text-black">
            Post A New Job
          </h1>
          <div className="flex-1">
            <RenderSteps />
        ...
        <div className="sticky top-10 hidden xl:block max-w-[400px] flex-1 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6">
          <p className="mb-8 text-base md:text-lg text-richblack-5">⚡ Job Post Tips</p>
