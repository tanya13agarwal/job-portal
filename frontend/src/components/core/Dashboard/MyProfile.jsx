...
export default function MyProfile() {
  ...
  return (
    <div className="px-4 lg:px-12">
      <h1 className="mb-8 text-3xl font-medium lg:text-4xl">My Profile</h1>

      {/* Section 1 */}
      {/* <div className="flex flex-col lg:flex-row items-center justify-between gap-y-6 shadow-lg bg-richblack-800 rounded-md border-[1px] border-richblack-700 p-6 lg:p-8">
        <div className="flex items-center gap-x-4">
          <img
            src={user?.image}
            alt={`profile-${user?.firstName}`}
        ...
        <button
          className="flex items-center gap-x-2 text-sm font-medium text-richblack-300"
  ...
  >
    ...
    <RiEditBoxLine />
      ...
      {/* Section 2 */}
      <div className="my-6 flex flex-col gap-y-4 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 lg:p-8">
        <div className="flex items-center justify-between">
          <p className="text-lg font-semibold text-richblack-5">
            {user.accountType === "Student" ? "Career Objective" : "Designation"}
          </p>
          <button
            className="flex items-center gap-x-2 text-sm font-medium text-richblack-300"
            onClick={() => navigate("/dashboard/settings")}
        ...
        >
          {user?.additionalDetails?.about
            ...
            ? "e.g., I am a MERN stack Developer"
            : "e.g., Team Lead"}
        </p>
      </div>
      ...
      <div className="my-6 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 lg:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
          ...
          <div>
            <p className="mb-2 text-sm text-richblack-600">Phone Number</p>
            <p className="text-sm font-medium text-richblack-5">
              {user?.additionalDetails?.ph_num ?? "Add Phone Number"}
            </p>
          </div>
          <div>
            <p className="mb-2 text-sm text-richblack-600">Gender</p>
        ...
        <div className="my-6 flex flex-col gap-y-6 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-6 lg:p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
            <div>
              <p className="mb-2 text-sm text-richblack-600">Semester</p>
              <p className="text-sm font-medium text-richblack-5">
                {user?.additionalDetails?.sem ?? "Add Your Sem"}
              </p>
            </div>
            <div>
              <p className="mb-2 text-sm text-richblack-600">Branch</p>
              <p className="text-sm font-medium text-richblack-5">
                {user?.additionalDetails?.brch ?? "Add Branch"}
              </p>
            </div>
            <div>
              <p className="mb-2 text-sm text-richblack-600">CGPA</p>
              <p className="text-sm font-medium text-richblack-5">
                {user?.additionalDetails?.cgpa ?? "Add CGPA"}
              </p>
            </div>
            <div>
              <p className="mb-2 text-sm text-richblack-600">Backlogs</p>
              <p className="text-sm font-medium text-richblack-5">
                {user?.additionalDetails?.bklgs ?? "Add Backlogs"}
              </p>
            </div>
            <div>
              <p className="mb-2 text-sm text-richblack-600">Resume</p>
            ...
            <div>
              <p className="mb-2 text-sm text-richblack-600">Portfolio Website</p>
              <p className="text-sm font-medium text-richblack-5">
                {user?.additionalDetails?.website ?? "Add Portfolio Website"}
              </p>
            </div>
          </div>
        </div>
